 ...
 * 
 */
@WebServiceClient(name = "HelloService", targetNamespace = "http://helloservice.jaxws.alekseysamoylov.com/", wsdlLocation = "http://localhost:8080/jaxws-example-1.0-SNAPSHOT/Hello?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOSERVICE_QNAME = new QName("http://helloservice.jaxws.alekseysamoylov.com/", "HelloService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/jaxws-example-1.0-SNAPSHOT/Hello?wsdl");
    ...
    public Hello getHelloPort() {
        return super.getPort(new QName("http://helloservice.jaxws.alekseysamoylov.com/", "HelloPort"), Hello.class);
    }
    ...
    public Hello getHelloPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://helloservice.jaxws.alekseysamoylov.com/", "HelloPort"), Hello.class, features);
    }
